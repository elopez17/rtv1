...
{
	return ((t_rgb){color.red * scalar, color.green * scalar, color.blue * scalar});
}

t_rgb	coloradd(t_rgb clr1, t_rgb clr2)
{
	return ((t_rgb){clr1.red + clr2.red, clr1.green + clr2.green, clr1.blue + clr2.blue});
}
...
{
	return ((t_rgb){(clr1.red + clr2.red) / 2, (clr1.green + clr2.green) / 2, (clr1.blue + clr2.blue) / 2});
}
